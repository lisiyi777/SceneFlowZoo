...
# class Network_4D(nn.Module):
#     def __init__(self, in_channel=32, out_channel=32, model_size=32):  # Increased from 16 → 32
#         super().__init__()
...
#         self.STDB_1_1_1 = SpatioTemporal_Block(in_channel, model_size, model_size, indice_key="st1_1", down_key='floor1')
#         self.STDB_1_1_2 = SpatioTemporal_Block(model_size, model_size, model_size * 2, indice_key="st1_1", down_key='floor1', pooling=True)

#         self.STDB_2_1_1 = SpatioTemporal_Block(model_size * 2, model_size * 2, model_size * 4, indice_key="st2_1", down_key='floor2')
#         self.STDB_2_1_2 = SpatioTemporal_Block(model_size * 4, model_size * 4, model_size * 8, indice_key="st2_1", down_key='floor2', pooling=True)

#         self.STDB_3_1_1 = SpatioTemporal_Block(model_size * 8, model_size * 8, model_size * 16, indice_key="st3_1", down_key='floor3')
#         self.STDB_3_1_2 = SpatioTemporal_Block(model_size * 16, model_size * 16, model_size * 16, indice_key="st3_1", down_key='floor3', pooling=True)

#         # NEW: Added an extra encoding stage
#         self.STDB_4_1_1 = SpatioTemporal_Block(model_size * 16, model_size * 16, model_size * 16, indice_key="st4_1", down_key='floor4')
#         self.STDB_4_1_2 = SpatioTemporal_Block(model_size * 16, model_size * 16, model_size * 16, indice_key="st4_1", down_key='floor4', pooling=True)

#         # Decoder with extra upsampling
#         self.up_subm_4 = spconv.SparseInverseConv4d(model_size * 16, model_size * 8, kernel_size=(2,2,2,1), indice_key='floor3', bias=False)
#         self.up_subm_3 = spconv.SparseInverseConv4d(model_size * 8, model_size * 4, kernel_size=(2,2,2,1), indice_key='floor2', bias=False)
#         self.up_subm_2 = spconv.SparseInverseConv4d(model_size * 4, model_size * 2, kernel_size=(2,2,2,1), indice_key='floor1', bias=False)
#         self.up_subm_1 = spconv.SparseInverseConv4d(model_size * 2, model_size, kernel_size=(2,2,2,1), indice_key='floor0', bias=False)  # NEW

#         self.STDB_1_2_1 = SpatioTemporal_Block(model_size * 2, model_size, out_channel, indice_key="st_1_2")
...
#         up_4 = self.up_subm_4(down_5)
#         up_4 = up_4.replace_feature(torch.cat((up_4.features, skip_4.features), 1))

#         up_3 = self.up_subm_3(up_4)
#         up_3 = up_3.replace_feature(torch.cat((up_3.features, skip_3.features), 1))

#         up_2 = self.up_subm_2(up_3)
#         up_2 = up_2.replace_feature(torch.cat((up_2.features, skip_2.features), 1))

#         up_1 = self.up_subm_1(up_2)  # NEW Upsampling stage
#         up_1 = up_1.replace_feature(torch.cat((up_1.features, skip_1.features), 1))

#         return self.STDB_1_2_1(up_1)